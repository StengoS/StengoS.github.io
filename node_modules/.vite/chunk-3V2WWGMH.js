import {
  ...
  shared,
  toFunction
} from "./chunk-UCGRS3Q2.js";
import {
  TileQueue_default,
  getTilePriority
} from "./chunk-TDQLMYAO.js";
import {
  Base_default,
...
import {
  Feature_default
} from "./chunk-67MBZZYL.js";
import {
  hasArea
} from "./chunk-Z5WRKJCK.js";
import {
  ImageState_default,
...
import {
  ...
  setFromArray,
  toString
} from "./chunk-37XBJ4CN.js";
import {
  easeOut,
  linear
} from "./chunk-C57CKQ55.js";
import {
  DEVICE_PIXEL_RATIO,
  FIREFOX,
  MAC,
...
var MapBrowserEvent = function(_super) {
  __extends3(MapBrowserEvent2, _super);
...
var PluggableMap = function(_super) {
  __extends5(PluggableMap2, _super);
...
var BaseVectorLayer = function(_super) {
  __extends7(BaseVectorLayer2, _super);
...
var CanvasBuilder = function(_super) {
  __extends8(CanvasBuilder2, _super);
...
var CanvasImageBuilder = function(_super) {
  __extends9(CanvasImageBuilder2, _super);
...
var CanvasLineStringBuilder = function(_super) {
  __extends10(CanvasLineStringBuilder2, _super);
...
var CanvasPolygonBuilder = function(_super) {
  __extends11(CanvasPolygonBuilder2, _super);
...
var CanvasTextBuilder = function(_super) {
  __extends12(CanvasTextBuilder2, _super);
...
function drawTextOnPath(flatCoordinates, offset, end, stride, text, startM, maxAngle, scale2, measureAndCacheTextWidth2, font, cache, rotation) {
  ...
  var endM = startM + scale2 * measureAndCacheTextWidth2(font, text, cache);
  ...
  for (var i = 0, ii = text.length; i < ii; ) {
    ...
    for (; i < ii; ++i) {
      ...
      var len = scale2 * measureAndCacheTextWidth2(font, text[index], cache);
...
var CanvasImmediateRenderer = function(_super) {
  __extends13(CanvasImmediateRenderer2, _super);
...
var CanvasVectorLayerRenderer = function(_super) {
  __extends14(CanvasVectorLayerRenderer2, _super);
...
var VectorLayer = function(_super) {
  __extends15(VectorLayer2, _super);
...
var MapRenderer = function(_super) {
  __extends16(MapRenderer2, _super);
...
var CompositeMapRenderer = function(_super) {
  __extends17(CompositeMapRenderer2, _super);
...
var Attribution = function(_super) {
  __extends19(Attribution2, _super);
...
var FullScreen = function(_super) {
  __extends22(FullScreen2, _super);
...
var MousePosition = function(_super) {
  __extends23(MousePosition2, _super);
...
var ControlledMap = function(_super) {
  __extends24(ControlledMap2, _super);
...
var OverviewMap = function(_super) {
  __extends24(OverviewMap2, _super);
...
var ScaleLine = function(_super) {
  ...
  ScaleLine2.prototype.createScaleBar = function(width, scale2, suffix) {
    ...
    for (var i = 0; i < this.scaleBarSteps_; i++) {
      ...
      scaleSteps.push('<div><div class="ol-scale-singlebar" style="width: ' + stepWidth + "px;background-color: " + backgroundColor + ';"></div>' + this.createMarker("relative", i) + (i % 2 === 0 || this.scaleBarSteps_ === 2 ? this.createStepText(i, width, false, scale2, suffix) : "") + "</div>");
...
var ZoomSlider = function(_super) {
  __extends26(ZoomSlider2, _super);
...
var ZoomToExtent = function(_super) {
  __extends27(ZoomToExtent2, _super);
...
var Interaction = function(_super) {
  __extends28(Interaction2, _super);
...
var DoubleClickZoom = function(_super) {
  __extends29(DoubleClickZoom2, _super);
...
var PointerInteraction = function(_super) {
  __extends30(PointerInteraction2, _super);
...
var DragRotate = function(_super) {
  __extends32(DragRotate2, _super);
...
var DragBoxEvent = function(_super) {
  __extends34(DragBoxEvent2, _super);
...
var KeyboardPan = function(_super) {
  __extends36(KeyboardPan2, _super);
...
var KeyboardZoom = function(_super) {
  __extends37(KeyboardZoom2, _super);
...
var MouseWheelZoom = function(_super) {
  __extends38(MouseWheelZoom2, _super);
...
var PinchRotate = function(_super) {
  __extends39(PinchRotate2, _super);
...
var DragAndDropEvent = function(_super) {
  __extends41(DragAndDropEvent2, _super);
...
var DragAndDrop = function(_super) {
  __extends41(DragAndDrop2, _super);
...
var DragRotateAndZoom = function(_super) {
  __extends42(DragRotateAndZoom2, _super);
...
var LineString = function(_super) {
  __extends44(LineString2, _super);
...
var MultiLineString = function(_super) {
  __extends45(MultiLineString2, _super);
...
var MultiPoint = function(_super) {
  __extends46(MultiPoint2, _super);
...
var MultiPolygon = function(_super) {
  __extends47(MultiPolygon2, _super);
...
var ExtentEvent = function(_super) {
  __extends49(ExtentEvent2, _super);
...
var ModifyEvent = function(_super) {
  __extends50(ModifyEvent2, _super);
...
var SelectEvent = function(_super) {
  __extends51(SelectEvent2, _super);
...
var TranslateEvent = function(_super) {
  __extends53(TranslateEvent2, _super);
...
//# sourceMappingURL=chunk-3V2WWGMH.js.map
